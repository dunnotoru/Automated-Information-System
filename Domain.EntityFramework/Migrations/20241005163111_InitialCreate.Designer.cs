...
namespace Domain.EntityFramework.Migrations
{
    ...
    [Migration("20241005163111_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Models.IdentityDocument", b =>
                {
                    ...
                    b.HasIndex("Series", "Number", "Name", "Surname", "Patronymic", "BirthDate")
                        .IsUnique();
            ...
            modelBuilder.Entity("Domain.Models.StationRoute", b =>
                {
                    b.Property<int>("RouteId")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Domain.Models.Run", b =>
                {
                    b.HasOne("Domain.Models.Driver", "Driver")
                        .WithOne("Run")
                        .HasForeignKey("Domain.Models.Run", "DriverId")
                        .IsRequired();
