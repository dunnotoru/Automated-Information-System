...
public sealed class DriverFormViewModel : EditViewModel
{
    ...
    {
        context.Drivers.Update(_driver);
        context.SaveChanges();
        context.Entry(_driver).Reload();
        return _driver.Id;
    }

    protected override void Remove(DomainContext context)
    {
        context.Remove(_driver);
        context.SaveChanges();
    }
    
    public DriverFormViewModel(IDbContextFactory<DomainContext> contextFactory) : base(contextFactory)
    {
    ...
    public DriverFormViewModel(Driver driver, IDbContextFactory<DomainContext> contextFactory) : base(contextFactory)
    {
        _driver = driver;
