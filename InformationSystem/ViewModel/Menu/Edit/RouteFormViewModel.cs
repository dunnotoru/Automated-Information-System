...
public sealed class RouteFormViewModel : EditViewModel
{
    ...
    public RouteFormViewModel(IDbContextFactory<DomainContext> contextFactory) : base(contextFactory)
    {
        _route = new Route();
    ...
    public RouteFormViewModel(Route route, IDbContextFactory<DomainContext> contextFactory) : base(contextFactory)
    {
        _route = route;
        Id = _route.Id;
        using DomainContext context = contextFactory.CreateDbContext();
