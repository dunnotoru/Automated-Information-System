...
public sealed class StationFormViewModel : EditViewModel
{
    ...
    public StationFormViewModel(IDbContextFactory<DomainContext> contextFactory) : base(contextFactory)
    {
        _station = new Station();
    }
    
    public StationFormViewModel(Station station, IDbContextFactory<DomainContext> contextFactory) : base(contextFactory)
    {
        _station = station;
        Id = _station.Id;
    }
