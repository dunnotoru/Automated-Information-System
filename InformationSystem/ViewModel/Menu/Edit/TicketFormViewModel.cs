...
public sealed class TicketFormViewModel : EditViewModel
{
    ...
    public TicketFormViewModel(IDbContextFactory<DomainContext> contextFactory) : base(contextFactory)
    {
        _ticket = new Ticket();
    }
    public TicketFormViewModel(Ticket ticket, IDbContextFactory<DomainContext> contextFactory) : base(contextFactory)
    {
        _ticket = ticket;
        Id = _ticket.Id;
    }
