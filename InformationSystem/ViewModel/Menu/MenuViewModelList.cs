...
public class BrandMenuViewModel : MenuViewModel<BrandEditViewModel, Brand>
{
    public BrandMenuViewModel(IMessageBoxService messageBoxService,
        IDbContextFactory<DomainContext> factory,
        EditViewModelFactory vmFactory) : base(messageBoxService,
        factory,
        vmFactory) { }
}
...
{
    public RunMenuViewModel(IMessageBoxService messageBoxService, IDbContextFactory<DomainContext> factory, EditViewModelFactory vmFactory) : base(messageBoxService, factory, vmFactory)
    {
    }
}
...
{
    public VehicleMenuViewModel(IMessageBoxService messageBoxService, IDbContextFactory<DomainContext> factory, EditViewModelFactory vmFactory) : base(messageBoxService, factory, vmFactory)
    {
    }
}
...
{
    public VehicleModelMenuViewModel(IMessageBoxService messageBoxService, IDbContextFactory<DomainContext> factory, EditViewModelFactory vmFactory) : base(messageBoxService, factory, vmFactory)
    {
    }
}
...
{
    public StationMenuViewModel(IMessageBoxService messageBoxService, IDbContextFactory<DomainContext> factory, EditViewModelFactory vmFactory) : base(messageBoxService, factory, vmFactory)
    {
    }
}
...
{
    public TicketMenuViewModel(IMessageBoxService messageBoxService, IDbContextFactory<DomainContext> factory, EditViewModelFactory vmFactory) : base(messageBoxService, factory, vmFactory)
    {
    }
}
...
{
    public TicketTypeMenuViewModel(IMessageBoxService messageBoxService, IDbContextFactory<DomainContext> factory, EditViewModelFactory vmFactory) : base(messageBoxService, factory, vmFactory)
    {
